...
1. Download the ZIP for your Odoo version:
   - `mcp_agents_financial_and_treasury_control_odoo16_v16.0.1.0.0.zip`
   - `mcp_agents_financial_and_treasury_control_odoo17_v17.0.1.0.0.zip`
   - `mcp_agents_financial_and_treasury_control_odoo18_v18.0.1.0.0.zip`
   - `mcp_agents_financial_and_treasury_control_odoo19_v19.0.1.0.0.zip`
...
2. Run: `./odoo-bin -u mcp_agents_financial_and_treasury_control -d YOUR_DB`
3. Restart Odoo
